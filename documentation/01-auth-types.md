...
- Note:
  ...
  - to change from one type of access control to the other, simply update the template with the code that is referenced below in the code examples.
...
- Setting up SAML SSO is a three-part process:
