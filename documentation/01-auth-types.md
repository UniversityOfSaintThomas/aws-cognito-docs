...
1. Open To All (Self-Registration):
	...
	- [Template Code Example](https://github.com/UniversityOfSaintThomas/aws-cognito-docs/blob/main/documentation/01-email-loop.md#1-open-to-all-authentication-self-registration)
...
2. Invite-Only / Admin Control:
	...
	- [Template Code Example](https://github.com/UniversityOfSaintThomas/aws-cognito-docs/blob/main/documentation/01-email-loop.md#2-invite-only-admin-control)
...
3. Restricted By Domain / Whitelist:
	...
	- [Template Code Example](https://github.com/UniversityOfSaintThomas/aws-cognito-docs/blob/main/documentation/01-email-loop.md#3-restricted-by-domain--whitelist)

### 2. Social / Third Party IdPs
- using public identity providers like Google, GitHub, etc to authenticate into the web app
- Not recommended for UST apps as we can use SSO or Email
- Brief Setup Guide (even though no one will use it 🥺)
